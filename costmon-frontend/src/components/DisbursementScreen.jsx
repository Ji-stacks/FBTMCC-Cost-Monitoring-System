  ...
  const proceedWithSubmission = (isPureStock, isDraftMode = false) => {
    ...
    if (isDraftMode) {
      ...
      const payloads = finalProjectCodes.map((projCode, index) => {
        ...
        return {
          ...
          target_cib: (isStockAllocationMode && stockAllocationSource) ? projNet : getSplitVal(finalHeaderData.target_cib),
    ...
    const payloads = finalProjectCodes.map((projCode, index) => {
      ...
      return {
        ...
        project_code: projCode || null,
        payee: finalHeaderData.payee || null,
        target_cib: isAllocation ? projNet : getSplitVal(finalHeaderData.target_cib),
        input_tax: getSplitVal(finalHeaderData.input_tax),
        output_tax: getSplitVal(finalHeaderData.output_tax),
